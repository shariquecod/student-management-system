...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      ' rounded-[24px] bg-background text-card-foreground shadow-[0_8px_32px_rgba(15,23,42,0.08)] transition-all duration-200 hover:shadow-[0_12px_40px_rgba(15,23,42,0.12)]',
      className
    )}
    {...props}
  />
